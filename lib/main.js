...
Formsy.Form = React.createClass({
  ...
  getDefaultProps: function getDefaultProps() {
    return {
      ...
      validateOnAttachToForm: true,
      validateOnDetachFromForm: true,
      validateOnFormMount: true
    };
  },
  ...
  componentDidMount: function componentDidMount() {
    if (this.props.validateOnFormMount) {
      this.validateForm();
    }
  },
  ...
  attachToForm: function attachToForm(component) {
    ...
    if (this.props.validateOnAttachToForm) {
  ...
  detachFromForm: function detachFromForm(component) {
    ...
    if (this.props.validateOnDetachFromForm) {
      this.validateForm();
    }
  },
  render: function render() {
    var _props = this.props,
        ...
        validateOnAttachToForm = _props.validateOnAttachToForm,
        validateOnDetachFromForm = _props.validateOnDetachFromForm,
        validateOnFormMount = _props.validateOnFormMount,
        nonFormsyProps = _objectWithoutProperties(_props, ['mapping', 'validationErrors', 'onSubmit', 'onValid', 'onValidSubmit', 'onInvalid', 'onInvalidSubmit', 'onChange', 'reset', 'preventExternalInvalidation', 'onSuccess', 'onError', 'validateOnAttachToForm', 'validateOnDetachFromForm', 'validateOnFormMount']);
